 ...
 */
package org.exoplatform.services.wcm.search.listener.page;
 ...
 */
public class MockUpdatePageEventListener extends Listener<UserPortalConfigService, Page> {
  
  /** The log. */
  private static Log log = ExoLogger.getLogger(MockUpdatePageEventListener.class);  
  ...
  public void onEvent(Event<UserPortalConfigService, Page> event) throws Exception {    
    ...
    try {
      publicationService.updateLifecyleOnChangePage(event.getData(), "root");
    } catch (Exception e) {
