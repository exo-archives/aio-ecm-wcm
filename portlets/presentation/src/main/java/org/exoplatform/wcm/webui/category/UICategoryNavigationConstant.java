...
public class UICategoryNavigationConstant {
  ...
  /** The Constant PREFERENCE_PORTLET_NAME. */
  ...
  /** The Constant PREFERENCE_TREE_TITLE. */
  ...
  /** The Constant PREFERENCE_TEMPLATE_CATEGORY. */
  public static final String PREFERENCE_TEMPLATE_CATEGORY     = "templateCategory";
  
  /** The Constant PREFERENCE_TEMPLATE_PATH. */
