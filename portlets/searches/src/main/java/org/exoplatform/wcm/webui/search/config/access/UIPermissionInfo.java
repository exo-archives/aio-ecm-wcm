...
public class UIPermissionInfo extends UIContainer {
   ...
   * @throws Exception 
   */
  private Node getCurrentWebContent() throws Exception {
    UIWCMSearchPortlet viewerPortlet = getAncestorOfType(UIWCMSearchPortlet.class);
    ...
    return uiDocumentDialogForm.getNode();
  }
