 ...
 */
package org.exoplatform.wcm.webui.search.config.access;
...
import org.exoplatform.wcm.webui.search.UIDocumentDialogForm;
...
@ComponentConfig(
    ...
    events = {
      ...
      @EventConfig(listeners = UIPermissionSetting.CloseActionListener.class),
...
public class UIPermissionSetting extends UIForm implements UISelectable {
  ...
  public static class SaveActionListener extends EventListener<UIPermissionSetting> {
    ...
    public void execute(Event<UIPermissionSetting> event) throws Exception {
      ...
      UIWCMSearchPortlet viewerPortlet = permissionSettingForm.getAncestorOfType(UIWCMSearchPortlet.class);
      ...
      UIDocumentDialogForm uiDocumentDialogForm = (UIDocumentDialogForm)popupWindow.getUIComponent();
      Node webContent = uiDocumentDialogForm.getNode();
  ...
  public static class CloseActionListener extends EventListener<UIPermissionSetting> {
    ...
    public void execute(Event<UIPermissionSetting> event) throws Exception {
      UIPermissionSetting uiPermissionSetting = event.getSource();
      UIWCMSearchPortlet viewerPortlet = uiPermissionSetting.getAncestorOfType(UIWCMSearchPortlet.class);
      //UISearchResult uiSearchResult = viewerPortlet.getChild(UISearchPageLayout.class).getChild(UISearchResult.class);
      UIPopupContainer popupContainer = viewerPortlet.getChildById("UISearchedContentEdittingPopup");
      UIPopupWindow popupWindow = popupContainer.findComponentById("UIContentEdittingPopupWindow");
      UIPopupWindow popupPermissionWindow = popupContainer.findComponentById("UIPermissionManagerPopupWindow");
      popupPermissionWindow.setShow(false);
