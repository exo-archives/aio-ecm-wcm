...
//    formGeneratorGeneralTab.addUIFormInput(new UIFormUploadInput(UIFormGeneratorConstant.ICON_FORM_UPLOAD_INPUT, UIFormGeneratorConstant.ICON_FORM_UPLOAD_INPUT));
  ...
  public static class SaveActionListener extends EventListener<UIFormGeneratorTabPane> {
    ...
    public void execute(Event<UIFormGeneratorTabPane> event) throws Exception {
      ...
      templateService.addTemplate(TemplateService.DIALOGS, nodetypeName, templateName, true, Utils.cleanString(templateName), new String[] {"*"}, newDialogTemplate, preferenceRepository) ;
      templateService.addTemplate(TemplateService.VIEWS, nodetypeName, templateName, true, Utils.cleanString(templateName), new String[] {"*"}, newViewTemplate, preferenceRepository) ;
      templateService.addTemplate(TemplateService.SKINS, nodetypeName, templateName, true, Utils.cleanString(templateName), new String[] {"*"}, "", preferenceRepository) ;
