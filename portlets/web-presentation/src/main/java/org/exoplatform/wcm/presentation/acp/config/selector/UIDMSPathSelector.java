...
public class UIDMSPathSelector extends UIBaseNodeTreeSelector {

  public UIDMSPathSelector() throws Exception {
    addChild(UIDMSTreeBuilder.class, null, UIDMSTreeBuilder.class.getSimpleName() + hashCode());
