...
public class UICSSFileManager extends UIContainer {

  public UICSSFileManager() throws Exception {
    addChild(UICSSGrid.class, null, null);
  }
  ...
  public void initCssPoupup() throws Exception {
    ...
    UIPopupWindow uiPopup = getChildById("CSSPopup");
    if(uiPopup == null) uiPopup = addChild(UIPopupWindow.class, null, "CSSPopup");
