...
public class UIBannerEditModeContainer extends UITabPane {
  public UIBannerEditModeContainer() throws Exception {
    UIBannerBasicEditModeForm basicEditModeForm = addChild(UIBannerBasicEditModeForm.class, "basicEdit", null);
    addChild(UIBannerAdvanceEditModeForm.class, "advanceEdit", null);
