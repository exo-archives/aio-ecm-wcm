...
@ComponentConfig (
    ...
    events = {
      @EventConfig(listeners = UIBannerEditContentForm.SaveActionListener.class),
      @EventConfig(listeners = UIBannerEditContentForm.CancelActionListener.class)
    }
)
public class UIBannerEditContentForm extends UIDialogForm {
  ...
  public static class SaveActionListener extends EventListener<UIBannerEditContentForm> {
    public void execute(Event<UIBannerEditContentForm> event) throws Exception {
      UIBannerEditContentForm bannerEditModeForm = event.getSource();
  ...
  public static class CancelActionListener extends EventListener<UIBannerEditContentForm> {
    public void execute(Event<UIBannerEditContentForm> event) throws Exception {
      PortletRequestContext context = (PortletRequestContext) event.getRequestContext();
      context.setApplicationMode(PortletMode.VIEW);
    }
