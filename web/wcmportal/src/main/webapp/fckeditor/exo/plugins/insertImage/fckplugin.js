FCKCommands.RegisterCommand( "WCMInsertImage", new FCKDialogCommand("WCMInsertImage", "", FCKConfig.eXoPath + "explorer/explorer.html?Type=Image&Connector=/portal/rest/wcmImage/", 900, 600) );
