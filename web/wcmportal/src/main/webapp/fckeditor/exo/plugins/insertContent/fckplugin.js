//Insert Content
FCKCommands.RegisterCommand( "WCMInsertContent", new WCMDialogCommand("WCMInsertContent", "", FCKConfig.eXoPath + "content/content.html?Type=File&Connector=/portal/rest/wcmDriver/getDrivers?repositoryName=repository&workspaceName=collaboration", 800, 600,null,null,"toolbar=no,status=no,resizable=yes,dependent=yes,scrollbars=yes") );
