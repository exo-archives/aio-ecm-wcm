...
public class ChangeStateCronJob extends CronJob {
	...
	ExoProperties props = params.getPropertiesParam("changeStateCronJob.generalParams").getProperties();
	...
	if (log.isInfoEnabled()) {
	    log.info("CronJob Param...fromState : " + fromState + ", toState : " + toState + ", predefinedPath : " + predefinedPath);
