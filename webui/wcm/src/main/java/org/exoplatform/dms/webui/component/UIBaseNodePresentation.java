 ...
 * Mar 18, 2008  
 */
public abstract class UIBaseNodePresentation extends UIComponent implements UINodePresentation {
  ...
  @Deprecated
  public String getNodeType() throws Exception { return getNode().getPrimaryNodeType().getName() ; }  
  ...
  public boolean isNodeTypeSupported() {
    try {      
      TemplateService templateService = getApplicationComponent(TemplateService.class);
      return templateService.isManagedNodeType(getNodeType(), getRepositoryName());
    } catch (Exception e) {
      return false;
    }
  }
