...
import org.exoplatform.dms.webui.form.validator.CronExpressionValidator;
import org.exoplatform.dms.webui.form.validator.ECMNameValidator;
import org.exoplatform.dms.webui.form.validator.RepeatCountValidator;
import org.exoplatform.dms.webui.form.validator.RepeatIntervalValidator;
...
public abstract class UIBaseDialogForm extends UIForm {
  ...
  public UIBaseDialogForm() throws Exception {}
  ...
  public Session getSesssion() throws Exception {
    ...
    return SessionProviderFactory.createSystemProvider().getSession(workspaceName_, getRepository()) ;
  }
  ...
  public void save(Event event) throws Exception {
    String path = storedPath_ + "&workspaceName=" + workspaceName_ + 
    "&repository=" + repositoryName_;
    for(String interceptor : prevScriptInterceptor_) {
      String scriptPath = interceptor.split(";")[0] ;
      String type = interceptor.split(";")[1] ;
      if(type.equals("prev")) {
        executeScript(scriptPath, path, null) ;          
      } 
    }
    Node newNode = storeValue(event) ;
  ...
  public abstract void onchange(Event event) throws Exception ;
