...
@ComponentConfig(
    ...
    events = @EventConfig(listeners = UINodePaginator.ShowPageActionListener.class )    
)
public class UINodePaginator extends UIComponent {
  ...
  static  public class ShowPageActionListener extends EventListener<UINodePaginator> {
    public void execute(Event<UINodePaginator> event) throws Exception {
      UINodePaginator uiPageIterator = event.getSource() ;
